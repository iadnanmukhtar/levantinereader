...
function matchesWordNonVerb(bw, incPrefix, incSuffix) {
    ...
    var m = null;
    if (incPrefix && incSuffix) {
        m = bw.match(/^([wb]?(Al|ll)?l?)(.+?)(h|w|hm|hn|hA|k|ky|km|kn|na|y)?$/);
        stemGroup = 3;
    } else if (incPrefix) {
        m = bw.match(/^([wb]?(Al)?l?)(.+?)$/);
        stemGroup = 3;
...
function findVerbPresentTense(bw) {
    var name = 'present';
    var error = true;
    var meta = null;
    var stem = "";
    var m = bw.match(/^w?(by|bt|b|mn|bn|y|t|n|A)(.{2,4})l?(h|hm|hn|hA|wA|ny|na|w)?$/);
    if (m !== null) {
...
function findVerbImperitiveTense(bw) {
    ...
    var meta = null;
    var stem = "";
    var m = bw.match(/^w?(A?.{2,4})l?(h|hm|hn|hA|wA|ny|na|w)?$/);
    if (m !== null) {
...
function findVerbPastTense(bw) {
    var name = 'past';
    var error = true;
    var meta = null;
    var stem = "";
    var m = bw.match(/^w?(.+?)(t|wA|ty|tw|twA|nA)?$/);
    if (m !== null) {
